...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestURL, getRequestHeaders, handleCors, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, sendNoContent, setHeader, assertMethod, readFormData, getValidatedRouterParams, getValidatedQuery, getHeader, getRequestWebStream, readValidatedBody, getResponseStatusText } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/h3/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1, ofetch } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/ofetch/dist/node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/unstorage/dist/index.mjs';
import httpDriver from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/unstorage/drivers/http.mjs';
import cloudflareKVBindingDriver from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/unstorage/drivers/cloudflare-kv-binding.mjs';
import mime from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/mime/dist/src/index.js';
import { z } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/zod/lib/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/defu/dist/defu.mjs';
import { randomUUID } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/uncrypto/dist/crypto.node.mjs';
import { parse } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/pathe/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/devalue/index.js';
import destr from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/@unhead/ssr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/scule/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/egorvilavin/Desktop/app_test/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "wrangler": {
    "configPath": "/Users/egorvilavin/Desktop/app_test/.data/hub/wrangler.toml",
    "persistDir": "/Users/egorvilavin/Desktop/app_test/.data/hub"
  }
};
const envOptions = {
  prefix: "NITRO_",
...
const serverAssets = [{"baseName":"server","dir":"/Users/egorvilavin/Desktop/app_test/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/egorvilavin/Desktop/app_test","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/egorvilavin/Desktop/app_test/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/egorvilavin/Desktop/app_test/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/egorvilavin/Desktop/app_test/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/egorvilavin/Desktop/app_test/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _SHvoDlHwwI = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/egorvilavin/Desktop/app_test";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _I0IDmsyebi = (nitroApp) => {
...
const _He6agc6jQi = defineNitroPlugin(async () => {
...
const _qURXnstzDI = (function(nitroApp) {
...
const _JkZx8x = eventHandler((event) => {
  handleCors(event, {
    methods: "*",
    origin: [
...
const _lazy_NbkEvv = () => Promise.resolve().then(function () { return ____feature_$1; });
const _lazy_EZHM7K = () => Promise.resolve().then(function () { return index_head$1; });
const _lazy_NZUKxX = () => Promise.resolve().then(function () { return manifest_get$1; });
const _lazy_coPKpc = () => Promise.resolve().then(function () { return openapi_get$1; });
const _lazy_4cSRpV = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/_hub/**:feature', handler: _lazy_NbkEvv, lazy: true, middleware: false, method: undefined },
  { route: '/api/_hub', handler: _lazy_EZHM7K, lazy: true, middleware: false, method: "head" },
  { route: '/api/_hub/manifest', handler: _lazy_NZUKxX, lazy: true, middleware: false, method: "get" },
  { route: '/api/_hub/openapi', handler: _lazy_coPKpc, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_4cSRpV, lazy: true, middleware: false, method: undefined },
  { route: '/api/_hub', handler: _JkZx8x, lazy: false, middleware: true, method: undefined },
  { route: '/**', handler: _lazy_4cSRpV, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/egorvilavin/Desktop/app_test/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/egorvilavin/Desktop/app_test/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
